...
$("#button4").click(function(){
  document.location = 'https://helpdesk.ello.co.za/v4_6_release/services/system_io/customerportal/portal.html?company=ELLO&locale=en#LoginPagePlace:LOGOUT';
  return false;
});

$("#button6").click(function(){
  document.location = 'http://remotesupport.ello.co.za/labtech/CC/quick.aspx?Action=Remote&locale=en';
  return false;
});

$("#button7").click(function(){
  document.location = 'http://survey.ello.co.za';
  return false;
});